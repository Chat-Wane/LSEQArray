 ...
 */
function Identifiers(d, s, c){
    this._d = d;
    this._s = s;
    this._c = c;
};

Identifiers.prototype.compare = function(o){
	...
	// #1a truncate mine
	var mine = Math.floor(this._d / Math.pow(2, dBitLength - sum));
	// #1b truncate other
	var other = Math.floor(o._d / Math.pow(2, odBitLength - sum));
	// #2 Compare triples
